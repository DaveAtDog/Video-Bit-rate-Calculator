...
(function (global) {
		...
		DomAttribute.prototype = {
			bind: function (lazy) {
				var self = this,
					...
					interpolator, keypath, index, options, option, i, len;
	...
	DomElement.prototype = {
		addEventProxy: function (triggerEventName, proxyDescriptor, contextStack) {
			var self = this,
				root = this.root,
				proxyName, proxyArgs, dynamicArgs, reuseable, definition, listener, fragment, handler, comboKey;
		...
		teardown: function (detach) {
			var self = this,
				tearThisDown, transitionManager, transitionName, transitionParams, listener, outro;
